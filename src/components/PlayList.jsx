...
import "../styles/playlist.module.css"; // Import CSS file for styling
        ...
        {playlist.map((track, index) => (
          <li key={index} className="playlist-track">
            <div>
              ...
              <p className="track-details">{track.artists.map(artist => artist.name).join(", ")} - {track.album.name}</p>
            </div>
            <button onClick={() => handleRemoveFromPlaylist(index)} className="remove-button">Remove</button>
          </li>
        ))}
      </ul>
    </div>
